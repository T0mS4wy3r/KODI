...
def MODIFY():
	xbmcgui.Dialog().ok('رسالة من المبرمج','هذه القائمة اختيرت عشوائيا والمبرمج لا يعرف أصحابها . للمساهمة في تغييرها . قم بمراسلة المبرمج من قائمة خدمات البرنامج . وأعلم أن للمبرمج كامل الحرية في قبول طلبك أو رفضه')
	send = xbmcgui.Dialog().yesno('رسالة من المبرمج','لإضافة أو حذف موقع أو قسم . قم بكتابة أسم ورابط الموقع أو القسم الذي تريد إضافته أو حذفه علما أن المواقع ذات الأسماء الشخصية أو ذات الفيديوهات القليلة مرفوضة . هل تريد الآن أن ترسل رسالة إلى المبرمج ؟!','','','كلا','نعم')
	if send:
		import SERVICES
