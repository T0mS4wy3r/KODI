...
if mode=='MAIN_MENU':
	...
	addLink(' [COLOR FFC89008]'+' البرنامج إصدار رقم ('+addon_version+')  .5 [/COLOR]','',7,'','','IsPlayable=no')
	addDir(' [COLOR FFC89008] 6.  [/COLOR]'+'قنوات تلفزيونية وبث حي','',170)
	addDir(' [COLOR FFC89008] 7.  [/COLOR]'+'ـ IPTV (اشتراك مدفوع)','',230)
	addDir(' [COLOR FFC89008] 8.  [/COLOR]'+'بحث بجميع مواقع البرنامج','',6)
	addDir(' [COLOR FFC89008] 9.  [/COLOR]'+'مشاهدة فيديوهات عشوائية','',8)
	addLink('[COLOR FFC89008]مواقع سيرفرات خاصة - قليلة المشاكل[/COLOR]','',157,'','','IsPlayable=no')
	addDir('10.  [COLOR FFC89008]IFL    [/COLOR]'+'موقع قناة آي فيلم','',20)
	...
	addDir('20.  [COLOR FFC89008]EGV  [/COLOR]'+'موقع إيجي بيست vip','',220)    # 220
...
elif mode>=220 and mode<=229: import EGYBESTVIP ; EGYBESTVIP.MAIN(mode,url,page,text)
