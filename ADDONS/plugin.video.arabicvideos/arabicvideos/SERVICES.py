...
def SEND_MESSAGE(text=''):
	...
	if problem:
		...
		"""
	xbmcgui.Dialog().ok('كتابة وشرح المشكلة للمبرمج','في الشاشة القادمة حاول أن تكتب رسالة للمبرمج واشرح فيها المشكلة وإذا أردت جواب من المبرمج فإذن أكتب عنوان بريدك ألإلكتروني الايميل وتذكر ولا تنسى أن المبرمج لا يعلم الغيب')
