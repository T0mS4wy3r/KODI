...
def MENU():
	...
	addMenuItem('folder','[COLOR FFC89008]  1.  [/COLOR]'+'مواقع البرنامج','',261)
	addMenuItem('folder','[COLOR FFC89008]  2.  [/COLOR]'+'مواقع إضافية من يوتيوب','',290)
	addMenuItem('folder','[COLOR FFC89008]  3.  [/COLOR]'+'قائمة الاقسام','',165,'','','SITES')
	addMenuItem('folder','[COLOR FFC89008]  4.  [/COLOR]'+'قائمة العشوائية','',160)
	addMenuItem('folder','[COLOR FFC89008]  5.  [/COLOR]'+'بحث بجميع المواقع','',262)
	...
	addMenuItem('link','[COLOR FFC89008]====================[/COLOR]','',9999)
	addMenuItem('folder','[COLOR FFC89008]  9.  [/COLOR]'+'قائمة المفضلة 1','',270,'','','','1')
	addMenuItem('folder','[COLOR FFC89008]10.  [/COLOR]'+'قائمة المفضلة 2','',270,'','','','2')
	addMenuItem('folder','[COLOR FFC89008]11.  [/COLOR]'+'قائمة المفضلة 3','',270,'','','','3')
	addMenuItem('folder','[COLOR FFC89008]12.  [/COLOR]'+'قائمة المفضلة 4','',270,'','','','4')
	addMenuItem('folder','[COLOR FFC89008]13.  [/COLOR]'+'قائمة المفضلة 5','',270,'','','','5')
	addMenuItem('folder','[COLOR FFC89008]14.  [/COLOR]'+'آخر 30 فيديو تم تشغيلها','',265,'','','video')
	addMenuItem('folder','[COLOR FFC89008]15.  [/COLOR]'+'آخر 30 قناة تم تشغيلها','',265,'','','live')
	addMenuItem('folder','[COLOR FFC89008]16.  [/COLOR]'+'آخر 30 مجلد تم فتحها','',265,'','','folder')
	addMenuItem('link','[COLOR FFC89008]====================[/COLOR]','',9999)
	addMenuItem('link','[COLOR FFC89008]17.  [/COLOR]'+'تقرير عن استخدام البرنامج','',176)
	addMenuItem('link','[COLOR FFC89008]18.  [/COLOR]البرنامج إصدار رقم ( '+addon_version+' )','',7)
	...
	addMenuItem('folder','[COLOR FFC89008]19.  [/COLOR]ـ Answers Menu  قائمة الاجوبة','',263)
	addMenuItem('folder','[COLOR FFC89008]20.  [/COLOR]ـ Services Menu  قائمة الخدمات','',264)
	addMenuItem('link','[COLOR FFC89008]21.  [/COLOR]ـ Contact Me  كيف تتصل بالمبرمج','',196)
	addMenuItem('link','[COLOR FFC89008]====================[/COLOR]','',9999)
	return
...
def SERVICES_MENU():
	...
	addMenuItem('link','[COLOR FFC89008]====================[/COLOR]','',9999)
	addMenuItem('link','[COLOR FFC89008]  4.  [/COLOR]'+'إرسال رسالة إلى المبرمج','',2,'','','')
	addMenuItem('link','[COLOR FFC89008]  5.  [/COLOR]'+'إبلاغ المبرمج بوجود مشكلة','',2,'','','PROBLEM')
	addMenuItem('link','[COLOR FFC89008]  6.  [/COLOR]'+'إرسال سجل الأخطاء والاستخدام','',2,'','','PROBLEM')
	addMenuItem('link','[COLOR FFC89008]====================[/COLOR]','',9999)
	addMenuItem('link','[COLOR FFC89008]  7.  [/COLOR]'+'فحص وتفعيل مخزن عماد','',172)
	addMenuItem('link','[COLOR FFC89008]  8.  [/COLOR]'+'فحص وتفعيل فيديوهات mpd','',173)
	addMenuItem('link','[COLOR FFC89008]  9.  [/COLOR]'+'فحص وتفعيل فيديوهات rtmp','',174)
	addMenuItem('link','[COLOR FFC89008]10.  [/COLOR]'+'فحص الإصدار الأخير والتحديثات','',7)
	addMenuItem('link','[COLOR FFC89008]11.  [/COLOR]'+'فحص اتصال المواقع المشفرة','',4)
	addMenuItem('link','[COLOR FFC89008]====================[/COLOR]','',9999)
	addMenuItem('link','[COLOR FFC89008]12.  [/COLOR]'+'إعدادات واجهة كودي','',6)
	addMenuItem('link','[COLOR FFC89008]13.  [/COLOR]'+'إعدادات ResolveURL','',177)
	addMenuItem('link','[COLOR FFC89008]14.  [/COLOR]'+'إعدادات Youtube-DL','',178)
	addMenuItem('link','[COLOR FFC89008]15.  [/COLOR]'+'إعدادات Inputstream Adaptive','',5)
	addMenuItem('link','[COLOR FFC89008]====================[/COLOR]','',9999)
	return
...
def GLOBAL_SEARCH_MENU(search='',show=True):
	...
	addMenuItem('folder','[COLOR FFC89008]KRB  [/COLOR]'+search2+' - موقع قناة كربلاء','',329,'','',search)
	...
	addMenuItem('folder','[COLOR FFC89008]SHV  [/COLOR]'+search2+' - موقع صوت الشيعة','',319,'','',search)
	addMenuItem('folder','[COLOR FFC89008]FTM   [/COLOR]'+search2+' - موقع المنبر الفاطمي','',69,'','',search)
	#addMenuItem('link','[COLOR FFC89008]====================[/COLOR]','',9999)
	addMenuItem('link','[COLOR FFC89008]مواقع سيرفرات خاصة وعامة - كثيرة المشاكل[/COLOR]','',157)
	addMenuItem('folder','[COLOR FFC89008]CMN  [/COLOR]'+search2+' - موقع سيما ناو','',309,'','',search)
