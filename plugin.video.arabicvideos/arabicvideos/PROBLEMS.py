...
def MAIN(mode):
	if mode==150:
		...
		yes = xbmcgui.Dialog().yesno('فحص جميع مواقع البرنامج','غرض هذا الفحص هو معرفة هل المشكلة من عندك ام من البرنامج. سيقوم البرنامج الان بفحص مواقعه مرتين الاولى بوضعك الطبيعي والثانية باستخدام بروكسي مجاني انت تختاره من القائمة التي ستظهر لاحقا. هل تريد الاستمرار؟','','','كلا','نعم')
		if yes==1:
			import PROGRAM
