...
def MAIN(mode):
	if mode==150:
		...
		addDir('[COLOR FFC89008]6.  [/COLOR]'+'لماذا لا نفحص شهادة التشفير','',193)
		addDir('[COLOR FFC89008]7.  [/COLOR]'+'بعض الروابط لا تعمل','',153)
		addDir('[COLOR FFC89008]8.  [/COLOR]'+'بعض الروابط بطيئة','',155)
		addDir('[COLOR FFC89008]9.  [/COLOR]'+'بعض الفيدوهات بطيئة وتقطع','',158)
		addDir('[COLOR FFC89008]10. [/COLOR]'+'لماذا يوجد سيرفرات مجهولة','',156)
		addDir('[COLOR FFC89008]11. [/COLOR]'+'ما هي السيرفرات العامة والخاصة','',157)
		addDir('[COLOR FFC89008]12. [/COLOR]'+'اين مواقع الافلام والمسلسلات الاجنبية','',154)
		addDir('[COLOR FFC89008]13. [/COLOR]'+'ما معنى هذه العلامات ,'+escapeUNICODE('\u02d1')+';','',191)
		...
		message1 = 'بعض المواقع تحتاج ربط مشفر وقد يكون جهازك غير قادر على الربط المشفر او هناك مشكلة في شهادة التشفير الخاصة بكودي عندك علما انه تم فحص البرنامج على كودي اصدار 17.6 , 18.2 , 18.3'
		...
		message = 'الغرض من شهادة التشفير هو ضمان صحت وسرية المعلومات المتبادلة بين البرنامج والموقع المشفر وهذا الضمان غير مطلوب ولا حاجة له عند الاتصال او الربط مع مواقع الفيديوهات المشفرة'
