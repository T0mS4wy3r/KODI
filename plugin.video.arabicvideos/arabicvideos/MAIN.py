...
if mode==-1:
	...
	addDir('قنوات تلفزونية وبث حي'+'  .3','',170)
	addDir('مشاهدة فيدوهات عشوائية'+'  .4','',8)
	addDir('بحث في جميع مواقع البرنامج'+'  .5','',6)
	addLink('[COLOR FFC89008]مواقع سيرفرات خاصة - قليلة المشاكل[/COLOR]','',157,'','','IsPlayable=no')
	addDir('6.  [COLOR FFC89008]YUT  [/COLOR]'+'موقع يوتيوب (مشفر)','',140)
	addDir('7.  [COLOR FFC89008]SHF  [/COLOR]'+'موقع شوف ماكس (مشفر)','',50)
	...
	addDir('12. [COLOR FFC89008]KWT  [/COLOR]'+'موقع قناة الكوثر','',130)
	addDir('13. [COLOR FFC89008]FTM  [/COLOR]'+'موقع المنبر الفاطمي','',60)
	addDir('14. [COLOR FFC89008]EGB  [/COLOR]'+'موقع ايجي بيست (مشفر)','',5)    # 120
	addLink('[COLOR FFC89008]مواقع سيرفرات خاصة وعامة - كثيرة المشاكل[/COLOR]','',157,'','','IsPlayable=no')
	addDir('15.  [COLOR FFC89008]MVZ  [/COLOR]'+'موقع موفيزلاند اونلاين (مشفر)','',180)
	addDir('16.  [COLOR FFC89008]AKM  [/COLOR]'+'موقع اكوام (مشفر)','',70)
	addLink('[COLOR FFC89008]مواقع سيرفرات عامة - كثيرة المشاكل[/COLOR]','',157,'','','IsPlayable=no')
	addDir('17.  [COLOR FFC89008]HEL   [/COLOR]'+'موقع هلال يوتيوب (مشفر)','',90)
	addDir('18.  [COLOR FFC89008]SHA   [/COLOR]'+'موقع شاهد فوريو (مشفر)','',110)
	addDir('19.  [COLOR FFC89008]HLA   [/COLOR]'+'موقع هلا سيما (مشفر)','',80)
	addLink('[COLOR FFC89008]=========================[/COLOR]','',9999,'','','IsPlayable=no')
	addLink('ـMessage to developer    رسالة الى المبرمج'+'  .20','',2,'','','IsPlayable=no,problem=no')
	addDir('ـProblems & Questions    مشاكل وأسئلة'+'  .21','',150)
	addLink('ـ DMCA     قانون الألفية للملكية الرقمية'+'  .22','',3,'','','IsPlayable=no')
	addLink('مسح كاش البرنامج بالكامل'+'  .23','',9,'','','IsPlayable=no')
