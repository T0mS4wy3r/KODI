...
if mode==-1:
	...
	addLink('تحذير يخص شهادة التشفير'+'  .1','',171,'','','IsPlayable=no,problem=yes')
	addLink('ارسال مشكلة الى المبرمج'+'  .2','',2,'','','IsPlayable=no,problem=yes')
	addLink('الاصدار الاخير والتحديثات'+'  .3','',7,'','','IsPlayable=no')
	addLink('[COLOR FFC89008]=========================[/COLOR]','',9999,'','','IsPlayable=no')
	addDir('قنوات تلفزونية وبث حي'+'  .4','',170)
	addDir('مشاهدة فيدوهات عشوائية'+'  .5','',8)
	addDir('بحث في جميع مواقع البرنامج'+'  .6','',6)
	...
	#addDir('15. [COLOR FFC89008]EGB  [/COLOR]'+'موقع ايجي بيست','',5)    # 120
	...
	addDir('17.  [COLOR FFC89008]HEL   [/COLOR]'+'موقع هلال يوتيوب','',90)
	addDir('18.  [COLOR FFC89008]SHA   [/COLOR]'+'موقع شاهد فوريو','',110)
	addDir('19.  [COLOR FFC89008]HLA   [/COLOR]'+'موقع هلا سيما','',80)
	addLink('[COLOR FFC89008]=========================[/COLOR]','',9999,'','','IsPlayable=no')
	...
	addLink('مسح كاش البرنامج بالكامل'+'  .22','',9,'','','IsPlayable=no')
	addLink('فحص الاتصال بالمواقع المشفرة'+'  .23','',4,'','','IsPlayable=no')
	addLink('ـ DMCA     قانون الألفية للملكية الرقمية'+'  .24','',3,'','','IsPlayable=no')
