...
if mode==-1:
	...
	addDir('[COLOR FFC89008] 1.  [/COLOR]'+'ـ Services Menu  قائمة الخدمات','',172)
	addDir('[COLOR FFC89008] 2.  [/COLOR]'+'قنوات تلفزونية وبث حي','',170)
	addDir('[COLOR FFC89008] 3.  [/COLOR]'+'بحث بجميع مواقع البرنامج','',6)
	addDir('[COLOR FFC89008] 4.  [/COLOR]'+'مشاهدة فيدوهات عشوائية','',8)
	addLink('[COLOR FFC89008]مواقع سيرفرات خاصة - قليلة المشاكل[/COLOR]','',157,'','','IsPlayable=no')
	addDir(' 5.  [COLOR FFC89008]YUT  [/COLOR]'+'موقع يوتيوب','',140)
	addDir(' 6.  [COLOR FFC89008]SHF  [/COLOR]'+'موقع شوف ماكس','',50)
	addDir(' 7.  [COLOR FFC89008]KLA  [/COLOR]'+'موقع كل العرب','',10)
	...
	addDir('14. [COLOR FFC89008]AKM  [/COLOR]'+'موقع اكوام','',70)
	addDir('15. [COLOR FFC89008]EGB  [/COLOR]'+'موقع ايجي بيست الجديد','',120)    # 5
	addLink('[COLOR FFC89008]مواقع سيرفرات عامة - كثيرة المشاكل[/COLOR]','',157,'','','IsPlayable=no')
	addDir('16. [COLOR FFC89008]HEL  [/COLOR]'+'موقع هلال يوتيوب','',90)
	addDir('17. [COLOR FFC89008]HLA  [/COLOR]'+'موقع هلا سيما','',80)
	addDir('18. [COLOR FFC89008]SHA  [/COLOR]'+'موقع شاهد فوريو','',110)
	addDir('19. [COLOR FFC89008]ARL  [/COLOR]'+'موقع اراب لايونز','',200)
	addDir('20. [COLOR FFC89008]SFW  [/COLOR]'+'موقع سيريس فوروتش','',210)
